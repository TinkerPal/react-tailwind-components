      ...
      <div className="max-w-4xl mx-12 space-y-4 mt-12">
        ...
        <div className="pt-20 space-y-2 ">
          <div className="flex flex-row justify-between space-x-1 md:justify-normal">
            <button className="w-full md:w-auto flex justify-center items-center py-1 space-x-2 font-sans font-bold text-white rounded-md  bg-cyan-700 shadow-cyan-100 hover:bg-opacity-90 shadow-sm hover:shadow-lg border transition hover:-translate-y-0.5 duration-150">
