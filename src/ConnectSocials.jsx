      ...
      <div className="relative flex flex-col m-6   md:flex-row md:space-y-0 md:my-0  ">
        ...
        <div className="px-6 py-2 md:p-12">
          ...
          <div className="flex flex-wrap gap-4 justify-center md:justify-start  ">
            <button className="w-32 md:w-28 h-32 md:h-28 flex flex-col space-y-2 bg-cyan-50 border-2  border-cyan-700 rounded-2xl justify-center items-center text-center font-mono font-bold text-xl">
              <div>
