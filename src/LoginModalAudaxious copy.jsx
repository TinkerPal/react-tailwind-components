...
export default function LoginModalAudaxious() {
  return (
    <div className="flex items-center justify-center    bg-slate-100">
      ...
      <div className="relative flex flex-col m-6  space-y-10 bg-white shadow-2xl rounded-2xl md:flex-row md:space-y-0 md:my-0  ">
        {/* Left Side  */}
        <div className="p-6 md:p-12">
          {/* top  */}
          <h2 className="font-mono mb-5 text-4xl font-bold">Log In</h2>
          <p className="max-w-sm mb-12 -sans font-light text-gray-600">
            Log in to your account to upload or download pictures, musics or
            videos
          </p>
